<template>
  <div class="player" v-show="playlist.length>0">
    ...
    <div class="normal-player" v-show="fullScreen">
      ...
      <div class="bottom">
        ...
        <div class="progress-wrapper">
          ...
          <div class="progress-bar-wrapper"><progress-bar :percent="percent" @percentChange="onProgressChange"></progress-bar></div>
    ...
    <audio @timeupdate="updateTime" ref="audio" :src="currentSong.url" @canplay="ready" @error="error" @ended="end"></audio>
  </div>
</template>
